...
@ScriptManifest(category = Category.MISC, name = "EarthOrberAIO", author = "camalCase", version = 0.0)
public class EarthOrberMain extends AbstractScript implements PaintInfo, HumanMouseListener {
    ...
    private void initScript() {
        ...
        SettingsData settings = settingsLoader.loadFile("org.dreambot.settings.json", ScriptSettings.getSettingsData());
...
//        new AIAntiban();
        ...
        tree = new Fractal().setSimpleName("EarthOrber")
                .addChildren(
                        ...
                        new EnchantDueling().setSimpleName("Enchant Duelings until 60"),
                        new MuleOff().setSimpleName("Mule off"),
                        new AntiPkNode(),
                        new EarthOrbs(() -> true).setSimpleName("Earth Orb")
                );
    }
    ...
    public String[] getPaintInfo() {
        return new String[]{
                "cCEarthOrber AIO - " + timer.formatTime(),
