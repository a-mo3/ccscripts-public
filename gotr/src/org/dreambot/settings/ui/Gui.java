...
public class Gui extends JFrame {
    public Gui() {
        Field[] scriptSettings = ScriptSettings.getSettingsData().getClass().getDeclaredFields();
...
//        Field[] bondSettings = b.getClass().getDeclaredFields();
        ...
        MuleSettings m = muleSettingsLoader.loadFile("muleSettings.json", new MuleSettings());
        Field[] muleSettings = m.getClass().getDeclaredFields();
        ...
        tabs.add("Script Settings", makeSettingsList(
                scriptSettings,
                "settings.json",
                ScriptSettings.getSettingsData(),
...
//        tabs.add("Bond Settings", makeSettingsList(bondSettings, "bondSettings.json", b, "The price to buy a bond"));
    ...
    JPanel makeSettingsList(Field[] fields, String fileName, Object instance, String helpMessage) {
        ...
        for (Field f : fields) {
            panel.add(new GuiOption(f, instance));
        }
