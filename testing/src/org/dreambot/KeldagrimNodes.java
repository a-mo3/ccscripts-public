...
public class KeldagrimNodes {
    ...
    public static void addNodes() {
        ...
        // keldagrim entrance
        EntranceWebNode keldagrimEntrance = new EntranceWebNode(2781, 10161, 0);
        keldagrimEntrance.addDualConnections(fremTrollCaveBasic);

        EntranceWebNode keldagrimExit = new EntranceWebNode(2838, 10123, 0);
        ...
        ferry.addDualConnections(keldagrimBasic);
        wf.addWebNode(ferry);
