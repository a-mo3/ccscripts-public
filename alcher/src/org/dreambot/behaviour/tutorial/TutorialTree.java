...
public class TutorialTree extends Fractal {
    ...
    public TutorialTree() {
        addChildren(
                new GielinorGuideBranch().addChildren(
                                new SetNameLeaf().setSimpleName("Setting name"),
    ...
    public boolean isValid() {
        if (MyVarps.getTutVarp() < 1000 && !hasTut && Client.isLoggedIn()) Logger.info("You need cctutorial for the script to do tutorial island");
