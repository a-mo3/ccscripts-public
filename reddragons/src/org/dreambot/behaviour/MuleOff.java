...
public class MuleOff extends Fractal {
    ...
    public boolean isValid() {
        if (timer == null) timer = new Timer((long) ScriptSettings.getSettingsData().hoursUntilMuleOff * 1000 * 60 * 60);
        if (SafespotReds.FORTHOS_DUNGEON.contains(Players.getLocal())) return false;
