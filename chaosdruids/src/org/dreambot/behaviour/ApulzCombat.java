...
public class ApulzCombat extends Fractal {
    ...
    public ApulzCombat(Supplier<Boolean> acceptCondition) {
...
//                        .setSimpleName("Apulz moss giant"),
    ...
    public ApulzCombat setStyleSupplier(Supplier<CombatStyle> styleSupplier) {
