...
//                        .setStrict(true)
    ...
    private void buyItems(List<LoadoutItem> itemsToBuy) {
        if (Worlds.getCurrent().isF2P() && itemsToBuy.stream().anyMatch(x -> new Item(x.getItemId(), 0).isMembersOnly())) setResponse(Response.MEMBERS_ITEM_FTP_WORLD);
