...
public enum BarrowsBrothers implements PaintInfo {
    ...
    TORAG("Torag", new Tile(3553, 3283, 0), new Area(3563, 9693, 3576, 9682, 3), BarrowsVarbits.BARROWS_KILLED_TORAG, Skill.MAGIC, Prayer.PROTECT_FROM_MELEE, 115),
     ...
     * @param combatLevel
     */
    BarrowsBrothers(String name, Tile digTile, Area tombArea, int killedVarbit, Skill weakness, Prayer prayerStyle, int combatLevel) {
        this.name = name;
