package org.dreambot.behaviour.training.quests.animalmagnetism.behaviour.device;
...
public class TranslateNotes extends Fractal {
    ...
    public int onLoop() {
        if (!Inventory.contains(ItemID.RESEARCH_NOTES_10492)) {
            ...
            if (puzzle != null) {
                Logger.info("Trying to close ava puzzle " + puzzle);
                Logger.info("Close all " + Widgets.closeAll());
