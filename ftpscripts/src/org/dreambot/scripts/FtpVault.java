...
import org.dreambot.behaviour.CrackTheClueThree;
...
public class FtpVault extends PseudoScript implements ItemContainerListener {
    ...
    public void init() {
        ...
        tree.addChildren(
                ...
                new CrackTheClueThree(() -> true).setSimpleName("Crack the clue III")
        );
//        new AIAntiban();
    }
