...
public class MixedCombat extends Fractal {
    ...
    public MixedCombat(Supplier<Boolean> acceptCondition) {
        ...
        final EquipmentLoadout combatLoadout = new EquipmentLoadout()
                .addItem(EquipmentSlot.WEAPON, ItemID.IRON_SCIMITAR)
                .addItem(EquipmentSlot.AMULET, ItemID.AMULET_OF_STRENGTH)
                .addItem(EquipmentSlot.HAT, ItemID.IRON_FULL_HELM)
                .addItem(EquipmentSlot.CHEST, ItemID.IRON_PLATEBODY)
                .addItem(EquipmentSlot.LEGS, ItemID.IRON_PLATELEGS)
                .addItem(EquipmentSlot.SHIELD, ItemID.IRON_KITESHIELD);

        Fractal[] combatOptions = new Fractal[]{
                new StandardCombat(acceptCondition, VARROCK_COWS,
                        varrockCowSupplier,
                        foodIds)
                        .setEquipmentLoadout(combatLoadout)
