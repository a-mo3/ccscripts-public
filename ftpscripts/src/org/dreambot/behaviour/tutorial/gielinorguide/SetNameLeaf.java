...
import org.dreambot.behaviour.tutorial.TutorialNameStrategy;
...
public class SetNameLeaf extends Fractal {
    final TutorialNameStrategy nameStrategy;

    public SetNameLeaf(TutorialNameStrategy nameStrategy) {
        this.nameStrategy = nameStrategy == null ? TutorialNameStrategy.RANDOM : nameStrategy;
    }
...
//    }};
    ...
    @Override
    public int onLoop() {
//        929, 7 is the experienced player option
        WidgetChild experienced = Widgets.get(929, 7);
        if (experienced != null) {
            log("Select experienced player");
            experienced.interact();
...
//                    .execute();
    ...
    public String generateName() {
        if (nameStrategy == null || nameStrategy.nameSupplier == null) {
            ...
            return nameStrategy.nameSupplier.get();
        }
    }
}
