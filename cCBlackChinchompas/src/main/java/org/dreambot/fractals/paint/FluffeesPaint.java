package org.dreambot.fractals.paint;
...
public class FluffeesPaint {
    ...
    static Color[] txtcolors = new Color[]{Color.white};
    static Color[] backingcolors = new Color[]{new Color(0, 0, 0, 220)};
    static Color[] bordercolors = new Color[]{Color.white};
    public FluffeesPaint(PaintLocations location, PaintInfo paintInfo) {
        this(paintInfo,
                location,
                txtcolors,
                "test",
