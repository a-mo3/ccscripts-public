...
public class UseOnFractal extends Fractal {
    ...
    public int onLoop() {
        ...
        if (secondItemSupplier != null) {
            ...
            if (sleepCondition != null) Antiban.sleepUntil(sleepCondition, sleepTimeout);
            return ReactionGenerator.getNormal();
        }
    ...
    public UseOnFractal setArea(Tile tile) {
        this.area = tile.getArea(5);
        return this;
    }

    public UseOnFractal setArea(Tile tile, int radius) {
        this.area = tile.getArea(radius);
        return this;
    }
