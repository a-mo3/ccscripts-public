...
import org.dreambot.behaviour.method.calvarion.CalvarionLoadout;

public class CalvarionSettings {
    ...
    public CalvarionLoadout loadout = CalvarionLoadout.URSINE_DHIDE;
    ...
    public boolean flickPrayers = false;
}
