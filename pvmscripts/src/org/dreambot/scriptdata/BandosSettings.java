...
public class BandosSettings {
    @SerializedName("loadout")
    public BandosLoadout loadout = BandosLoadout.KARILS_DCB_BLOWPIPE;
    ...
    public boolean tileSkipping = false;
    @SerializedName("expensiveLootThreshold")
    public int expensiveLootThreshold = 50_000;
    @SerializedName("useBonesToPeaches")
    public boolean useBonesToPeaches = false;
    @SerializedName("useTrollheimTabs")
    public boolean useTrollheimTabs = false;
    @SerializedName("leaveWhenCrash")
    public boolean leaveWhenCrashed = true;
    @SerializedName("useNewFight")
    public boolean useNewFight = false;
}
