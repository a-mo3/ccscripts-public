...
//                    .addItem(EquipmentSlot.CAPE, ItemID.OBSIDIAN_CAPE)
                    ...
                    .addItem(EquipmentSlot.FEET, ItemID.DRAGON_BOOTS).setEnabledCondition(() -> Skill.DEFENCE.getLevel() >= 60),
            HueyConst.MELEE_INV,
            Skill.ATTACK),
...
//                    .addItem(ItemID.AIR_RUNE, 1000, 3000)
    ...
    HueyLoadout(org.dreambot.fractals.loadout.EquipmentLoadout equipmentLoadout, InventoryLoadout loadout, Skill mode) {
