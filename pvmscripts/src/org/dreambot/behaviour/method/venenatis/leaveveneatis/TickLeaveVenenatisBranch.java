 ...
 */
public class TickLeaveVenenatisBranch extends TickFractal {
    static List<Integer> food = Arrays.asList(
            ItemID.BLIGHTED_ANGLERFISH, ItemID.BLIGHTED_MANTA_RAY
    );

    public TickLeaveVenenatisBranch(int maxLoot, VenenatisLeaveMode leaveMode) {
        ...
        addChildren(
                ...
                new GenericTickEat().setAllowEat(() -> leaveMode != VenenatisLeaveMode.SUICIDE),
                ...
                new SuicideLeaveVenenatis(leaveMode == VenenatisLeaveMode.SUICIDE),

                new TickLeaveVenenatisDecision(),

                new VenenatisTickLoot().setSimpleName("Vene loot")
