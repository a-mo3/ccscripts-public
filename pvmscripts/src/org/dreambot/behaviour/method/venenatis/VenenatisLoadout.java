...
//                    .addItem(EquipmentSlot.CAPE, ItemVariants.AVAS_DEVICE),
            new InventoryLoadout()
                    .addItem(ItemID.RUNE_KNIFE, 75)
                    .setRefill(300)
                    .addItem(ItemID.BLIGHTED_SUPER_RESTORE4, 5, 5)
                    .setRefill(40)
                    .addItem(ItemID.ENERGY_POTION4, 3, 3)
                    .setRefill(40)
...
//                    .addItem(EquipmentSlot.CAPE, ItemVariants.AVAS_DEVICE),
    ...
    VenenatisLoadout(EquipmentLoadout equipmentLoadout, InventoryLoadout loadout, boolean isRange) {
