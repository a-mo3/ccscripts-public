 ...
 */
public class CalvarionTickPotion extends TickDecision implements ExperienceListener {
    public CalvarionTickPotion() {
    ...
    public boolean evaluate() {
        boolean isOnEatDelay = CalvarionTickEat.lastAteTick == 0 || Client.getGameTick() - CalvarionTickEat.lastAteTick < 3;
