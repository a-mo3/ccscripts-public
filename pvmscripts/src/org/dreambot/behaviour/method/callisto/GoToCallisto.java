...
public class GoToCallisto extends Fractal implements ChatListener {
    public static final Area CAVE_ENTRANCE = new Area(3287, 3851, 3297, 3843);
    Area FEROX_POOL = new Area(3127, 3636, 3130, 3633);
    public static final Area CALLISTO_ARENA = new Area(3344, 10343, 3374, 10312);

    public GoToCallisto() {
        super(() -> !CALLISTO_ARENA.contains(Players.getLocal()));
    ...
    public int onLoop() {
        ...
        if (Dialogues.inDialogue()) {
            if (Dialogues.canEnterInput()) Keyboard.type(" 1k", true);
