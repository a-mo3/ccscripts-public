...
public class KreeConsts {
    ...
    public static final InventoryLoadout brewInv = new InventoryLoadout()
            .addItem(ItemID.RUNE_DART, 600)
            .setEnabledCondition(() -> !Inventory.contains(ItemID.RUNE_DART))
            .addItem(ItemID.SARADOMIN_BREW4, () -> SettingsRepository.findInstanceOf(new KreearraSettings()).brewQuantity)
            .setRefill(50)
            .addItem(ItemID.SUPER_RESTORE4, () -> SettingsRepository.findInstanceOf(new KreearraSettings()).restoreQuantity)
            .setRefill(50)
            .addItem(ItemID.PRAYER_POTION4, () -> SettingsRepository.findInstanceOf(new KreearraSettings()).prayerQuantity)
            .setRefill(50)
            .addItem(ItemID.STAMINA_POTION4, () -> SettingsRepository.findInstanceOf(new KreearraSettings()).staminaQuantity)
            .setRefill(40)
            .addItem(ItemID.BLACK_CHINCHOMPA, () -> SettingsRepository.findInstanceOf(new KreearraSettings()).blackChinQuantity)
            .setEnabledCondition(() -> SettingsRepository.findInstanceOf(new KreearraSettings()).blackChinQuantity > 0)
            .addItem(ItemID.MITH_GRAPPLE_9419, 1)
            .setRefill(5)
            .addItem(ItemID.ECUMENICAL_KEY)
            .setEnabledCondition(() -> OwnedItems.contains(ItemID.ECUMENICAL_KEY))
            .addItem(ItemID.RUNE_POUCH);
