...
import org.dreambot.behaviour.tutorial.iron.IronmanState;
import org.dreambot.behaviour.tutorial.iron.SetIronman;
...
public class TutorialTree extends Fractal implements ConfigurableFractal<TutorialBranchSettings> {
...
//        setCleanAfterAccomplished(true);
        addChildren(
                new GielinorGuideBranch().addChildren(
                                new SetNameLeaf(getSettings().nameStrategy).setSimpleName("Setting name"),
                ...
                new WizardTutorialBranch()
                        .addChildren(
                                new SetIronman(() -> IronmanState.getCurrent() != getSettings().ironman && MyVarps.getTutVarp() > 670, getSettings().ironman)
                                        .setSimpleName("Become ironman " + getSettings().ironman),
    ...
    public TutorialBranchSettings getSettings() {
        return SettingsRepository.getSetting(settingName(), new TutorialBranchSettings());
    }
