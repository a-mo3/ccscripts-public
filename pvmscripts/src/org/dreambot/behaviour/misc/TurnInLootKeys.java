...
public class TurnInLootKeys extends Fractal {
    ...
    public TurnInLootKeys() {
        this.acceptCondition = () -> Inventory.contains("Loot key") && !Combat.isInWild();

        this.eventBreakCondition = () -> FEROX_BANK.contains(Players.getLocal());
//        this.inventoryLoadout = new InventoryLoadout()
//                .addItem(ItemVariants.RING_OF_DUELING)
//                .setEnabledCondition(() -> !FEROX_BANK.contains(Players.getLocal()) && !Combat.isInWild())
//                .strictIgnore(
//                        // loot key ids
//                        26651,
//                        26652,
