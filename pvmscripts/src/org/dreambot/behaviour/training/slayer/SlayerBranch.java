...
import org.dreambot.behaviour.training.slayer.tickslayer.TickSlayerTask;
import org.dreambot.behaviour.training.slayer.tickslayer.TickTaskMap;
...
public class SlayerBranch extends Fractal implements ChatListener, ConfigurableFractal<SlayerSettings> {
    ...
    private void init() {
        ...
        TickSlayerTask.mode = getSettings().slayerMode;
        addChildren(
                ...
                new Fractal().setSimpleName("Slayer")
                        .setPrependLogic(() -> {
                            TickTaskMap.execSlayerTask(getSettings().slayerMode);
                            return true;
                        })
        );
    ...
    public SlayerSettings getSettings() {
        return SettingsRepository.getSetting("slayer", new SlayerSettings());
    }
