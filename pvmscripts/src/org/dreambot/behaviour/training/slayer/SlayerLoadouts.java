...
//            .setRefill(5)
            ...
            .setEnabledCondition(() -> Skills.getRealLevel(Skill.DEFENCE) >= 40 && Skills.getRealLevel(Skill.DEFENCE) < 60)
...
//    public static final InventoryLoadout CANNON_LOADOUT_PRAYER = new InventoryLoadout(PRAYER_GEM_INVENTORY)
...
//            .setEnabledCondition(() -> PlayerSettings.getConfig(2) < 4);
    ...
    public static final EquipmentLoadout GUTHANS = new EquipmentLoadout()
            .addItem(EquipmentSlot.CAPE, ItemID.OBSIDIAN_CAPE)
            .addItem(EquipmentSlot.HAT, ItemVariants.GUTHANS_HELM)
            .setEnabledCondition(() -> Players.getLocal().getZ() != 1)
            .addItem(EquipmentSlot.HAT, ItemID.NOSE_PEG)
            .setEnabledCondition(() -> Players.getLocal().getZ() == 1)

            .addItem(EquipmentSlot.CHEST, ItemVariants.GUTHANS_CHEST)
            .addItem(EquipmentSlot.LEGS, ItemVariants.GUTHANS_SKIRT)
            .addItem(EquipmentSlot.WEAPON, ItemVariants.GUTHANS_SPEAR)
            // glory
            .addItem(EquipmentSlot.AMULET, ItemVariants.AMULET_OF_GLORY)
            .setRefill(5)
...
//            )
            ...
            .setRefill(5)
            .addItem(EquipmentSlot.CHEST, ItemID.RUNE_CHAINBODY)
            .setEnabledCondition(() -> Helper.skillBetween(Skill.DEFENCE, 60, 40))
            .setRefill(5)
            .addItem(EquipmentSlot.CHEST, ItemID.DRAGON_CHAINBODY)
            .setEnabledCondition(() -> Helper.skillBetween(Skill.DEFENCE, 100, 60))
            ...
            .setEnabledCondition(() -> Helper.skillBetween(Skill.DEFENCE, 60, 40))
            .setRefill(5)
            .addItem(EquipmentSlot.LEGS, ItemID.DRAGON_PLATELEGS)
            .setEnabledCondition(() -> Helper.skillBetween(Skill.DEFENCE, 100, 60))
