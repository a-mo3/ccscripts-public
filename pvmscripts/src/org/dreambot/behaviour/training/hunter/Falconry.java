...
public class Falconry extends Fractal {
    ...
    public Falconry(Supplier<Boolean> acceptCondition) {
        ...
        setSimpleName("Falconry");
        this.inventoryLoadout = new InventoryLoadout()
                .addItem(ItemID.VARROCK_TELEPORT, 2, 10)
                .addItem(ItemID.COINS_995, 500, 10_000)
                .setEnabledCondition(() -> !Equipment.contains(x -> x.getName().toLowerCase().contains("falcon")));
    }
