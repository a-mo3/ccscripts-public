package org.dreambot.behaviour.quests.animalmagnetism;
...
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.device.MakeDeviceFinish;
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.device.TranslateNotes;
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.holyaxe.CutDeadTree;
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.holyaxe.TalkToTurael;
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.magnet.MakeMagnet;
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.magnet.TalkToWitch;
import org.dreambot.behaviour.quests.animalmagnetism.behaviour.undeadchickens.*;
...
public class AnimalMagnetismBranch extends Fractal {
    ...
    public AnimalMagnetismBranch() {
        this.paintArraySupplier = () -> new String[]{
                "State " + PaidQuest.ANIMAL_MAGNETISM.getConfigValue()
        };
