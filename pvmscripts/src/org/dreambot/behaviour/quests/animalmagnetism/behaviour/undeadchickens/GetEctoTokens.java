...
public class GetEctoTokens extends Fractal implements ChatListener {
    ...
    public int onLoop() {
        ...
        if (SpecialWalker.enterMorytania()) {
            ...
            if (bone != null && bone.useOn(boneGrinder)) {
    ...
    public void onMessage(Message message) {
        ...
        if (message.getMessage().contains("bin before you put more")) binFlag = true;
    }
}
