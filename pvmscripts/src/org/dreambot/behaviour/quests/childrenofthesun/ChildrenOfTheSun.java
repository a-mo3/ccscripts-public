package org.dreambot.behaviour.quests.childrenofthesun;
...
public class ChildrenOfTheSun extends Fractal {
    ...
    public ChildrenOfTheSun() {
        ...
        addChildren(
                ...
                // peep conversation
                new TalkToFractal(() -> getState() == 8, new Tile(3259, 3400), () -> GameObjects.closest(50048))// door id according to quest helper
                        .setSimpleName("Attempt to enter house"),
                // talk to guard
