...
public class PriestInPeril extends Fractal {
    public PriestInPeril() {
        ...
        addChildren(
                SandCrabs.getMelee(() -> Skills.getRealLevel(Skill.STRENGTH) < 20).setSimpleName("Need some combats (20str)"),
                ...
                new AdvStandardCombat(() -> PaidQuest.PRIEST_IN_PERIL.getConfigValue() == 4 && !Inventory.contains(ItemID.GOLDEN_KEY),
