        ...
        addChildren(
                ...
                new TalkToFractal(() -> !PaidQuest.FISHING_CONTEST.isStarted(), VESTRI_HOUSE, VESTRI_SUP)
                        ...
                        .setInventoryLoadout(new InventoryLoadout()
                                ...
                                .addItem(ItemID.RED_VINE_WORM, 1, 3).enabledIfOwned()
                                ...
                                .addItem(ItemID.FISHING_PASS)
                                .setEnabledCondition(() -> OwnedItems.contains(ItemID.FISHING_PASS))
                        )
...
//                                ScriptSettings.getSettingsData().rebuyLoadout ?
                        ...
                        .setPrependLogic(() -> {
                            ...
                            if (Skills.getBoostedLevel(Skill.HITPOINTS) < 6 && Inventory.contains(ItemID.SHARK)) {
