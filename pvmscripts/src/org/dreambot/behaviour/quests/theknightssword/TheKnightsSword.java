package org.dreambot.behaviour.quests.theknightssword;
...
public class TheKnightsSword extends Fractal {
    ...
    public TheKnightsSword() {
        ...
        addChildren(
                new DoricsQuest(),
                new MixedMining(() -> Skills.getRealLevel(Skill.MINING) < 10),
//                new DeathHandleFractal(),
                ...
                new GetBlurite(() -> !OwnedItems.contains(ItemID.BLURITE_ORE) && !OwnedItems.contains(ItemID.BLURITE_SWORD))
