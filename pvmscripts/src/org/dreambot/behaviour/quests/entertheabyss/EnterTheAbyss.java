package org.dreambot.behaviour.quests.entertheabyss;
    ...
    public EnterTheAbyss() {
        ...
        addChildren(
                ...
                new TalkToFractal(() -> !MiniQuest.ENTER_THE_ABYSS.isStarted(), WILD_ZAMORAK_MAGE, () -> NPCs.closest("Mage of Zamorak"))
                        ...
                        .setPrependLogic(() -> {
                            if (Equipment.contains(x -> x.getName().toLowerCase().contains("guthix"))) {
                                Logger.info("Cant wear guthix items banking all");
                ...
                new TalkToFractal(() -> !OwnedItems.containsAny(ItemID.SCRYING_ORB, ItemID.SCRYING_ORB_5519), VARROCK_ZAM_MAGE, () -> NPCs.closest("Mage of Zamorak"))
                        .setDialogueOptions("lost", "orb", "runes from", "worth your while", "still help you", "Yes", "alright", "Deal.")
                        .setSimpleName("Talk to mage in Varrock for new scrying orb"),
                new TalkToFractal(() -> true, VARROCK_ZAM_MAGE, () -> NPCs.closest("Mage of Zamorak"))
                        .setDialogueOptions("runes from", "worth your while", "still help you", "Yes", "alright", "Deal.")
                        .setInventoryLoadout(
                                new InventoryLoadout()
                                        .addItem(ItemID.SCRYING_ORB)
                                        .setEnabledCondition(() -> OwnedItems.contains(ItemID.SCRYING_ORB))
                                        .addItem(ItemID.SCRYING_ORB_5519)
                                        .setEnabledCondition(() -> OwnedItems.contains(ItemID.SCRYING_ORB_5519))
                        )
