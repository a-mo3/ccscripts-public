...
import org.dreambot.behaviour.method.gwd.kree.group.GroupKree;
...
public class KreearraScript extends PseudoScript implements ItemContainerListener, SpawnListener {
    FractalRoot<KreearraSettings> tree = new FractalRoot<>(new KreearraSettings(), getScriptName());
...
//            .setRefill(5_000)
    ...
    public void init() {
        ...
        tree.addChildren(
                ...
                new TimedShuffleFractal(Calculations.random(40, 180))
                        .addChildren(
                ...
                new ConfigurableRangeTraining(() -> Skills.getRealLevel(Skill.RANGED) < tree.getSettings().rangeTarget || Skills.getRealLevel(Skill.DEFENCE) < tree.getSettings().defenceTarget)
                ...
                new ConfigurableMeleeTraining(() -> Skills.getRealLevel(Skill.STRENGTH) < 60 && Skills.getRealLevel(Skill.AGILITY) < 60)
                        .setSimpleName("60 Str to get into GWD"),


                new PlaceRopes(false).setSimpleName("Place GWD rope"),
                new GWDRechargeAtFerox().setSimpleName("Use Ferox pool"),

                new Fractal(() -> !GetKreeKC.ARMADYL_EYRiE.contains(Players.getLocal()) && !KillKreearra.KREE_BOSS_ROOM.contains(Players.getLocal())
                ...
                new Fractal(() -> tree.getSettings().groupMode)
                        .addChildren(
                                new GroupKree(() ->
                                        KillKreearra.KREE_BOSS_ROOM.contains(Players.getLocal())
                                        ...
                                        tree.getSettings()
                                ).setSimpleName("Kill kree group"),

                                new GetKreeKC(() -> true, tree.getSettings())
...
//        new AIAntiban();
    ...
    public int onLoop() {
        ...
        if (Skills.getBoostedLevel(Skill.STRENGTH) >= 60
            ...
            Sleep.sleepUntil(() -> boulderObstacle.getX() > Players.getLocal().getX(), 4400);
            return ReactionGenerator.getNormal();
        }
        return tree.run();
    }
    ...
    public String[] getPaintInfo() {
        ...
        return new String[]{
                ...
                "target: " + target,
                "Avian GP: " + avianGP,
                "Kree GP (Actual) " + KillKreearra.kreearraGP,
                "Kree GP (EV) " + KillKreearra.killCount * 300_000,
                "Kree kills " + KillKreearra.killCount
        };
    }

    @Override
    public void onScriptPaint(Graphics g) {
//        NPCs.all(KillKreearra.KREE_BOSS_ROOM::contains)
//                .forEach(x -> {
...
//                });
    ...
    public String getScriptName() {
        return "cCKreearraFarm";
    }

    @Override
    public int getMoneyMade() {
        return avianGP + KillKreearra.kreearraGP;
    }
