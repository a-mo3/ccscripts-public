...
public class ChaosElementalScript extends PseudoScript implements ItemContainerListener, ChatListener {
    FractalRoot<ChaosElementalSettings> tree = new FractalRoot<>(new ChaosElementalSettings(), getScriptName());

    @Override
    public void init() {
        Client.getInstance().addEventListener(this);
        tree.setSimpleName("cCChaosElemental");
...
//                                        .setDefenceTarget(settings.defenceTarget)
                ...
                new ChaosElemental(() -> true, tree.getSettings())
                        .setSimpleName("Chaos Elemental")
        );
    }
