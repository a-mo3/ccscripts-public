...
import org.dreambot.scriptdata.FrostDragonSettings;
 ...
 */
public class FrostDragonScript extends PseudoScript implements ItemContainerListener, ChatListener {
    FractalRoot<FrostDragonSettings> tree = new FractalRoot<>(new FrostDragonSettings(), getScriptName());

    @Override
    public void init() {
        Client.getInstance().addEventListener(this);
        tree.setSimpleName("cCFrostDragonFarm");
        ...
        tree.addChildren(
                ...
                new F2PMagicBranch(() -> Skills.getRealLevel(Skill.MAGIC) < tree.getSettings().ftpMagicTarget, tree.getSettings().ftpDefenseTarget)
                ...
                new ConfigurableMagicBranch(() -> tree.getSettings().magicTarget > Skills.getRealLevel(Skill.MAGIC))
                        .setSimpleName("Magic level"),

                // todo 72 construction maaaybe
                new SailingBranch(() -> Skills.getRealLevel(Skill.SAILING) < 82),
