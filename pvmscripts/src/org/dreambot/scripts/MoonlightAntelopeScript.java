...
import org.dreambot.behaviour.method.antelope.MoonlightAntelopes;
...
public class MoonlightAntelopeScript extends PseudoScript implements ItemContainerListener {
    FractalRoot<SunlightAntelopeSettings> tree = new FractalRoot<>(new SunlightAntelopeSettings(), getScriptName());
    ...
    public void init() {
        ...
        tree.setSimpleName("cCMoonlightAnts");
        tree.addChildren(
                ...
                new FletchBranch(() -> tree.getSettings().fletchBolts
                        && Skills.getRealLevel(Skill.FLETCHING) < 72)
                        .setSimpleName("Fletching till 72"),
