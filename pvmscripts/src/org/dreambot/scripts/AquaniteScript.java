...
import org.dreambot.scriptdata.AquaniteSettings;
 ...
 */
public class AquaniteScript extends PseudoScript implements ItemContainerListener, ChatListener {
    FractalRoot<AquaniteSettings> tree = new FractalRoot<>(new AquaniteSettings(), getScriptName());

    @Override
    public void init() {
        Client.getInstance().addEventListener(this);
        tree.setSimpleName("cCAquaniteSettings");
