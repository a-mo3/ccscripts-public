package org.dreambot.behaviour.training.impcatcher;
...
public class ImpCatcher extends Fractal {
    ...
    public ImpCatcher() {
        this.inventoryLoadout = new InventoryLoadout()
                .addItem(ItemID.RED_BEAD).setBuyPrice(ScriptSettings.getSettingsData().beadBuyPrice)
                .addItem(ItemID.YELLOW_BEAD).setBuyPrice(ScriptSettings.getSettingsData().beadBuyPrice)
                .addItem(ItemID.BLACK_BEAD).setBuyPrice(ScriptSettings.getSettingsData().beadBuyPrice)
                .addItem(ItemID.WHITE_BEAD).setBuyPrice(ScriptSettings.getSettingsData().beadBuyPrice)
                .setMuleRequestAmount(50_000)
                .setStrict(true)
        ;
    }
