...
import org.dreambot.behaviour.training.animalmagnetism.util.SpecialWalker;
...
public class GetMoreAvas extends Fractal {
    public GetMoreAvas() {
        this.inventoryLoadout = new InventoryLoadout()
                .addItem(ItemID.COINS_995, 20_0000)
    ...
    public boolean isValid() {
        ...
        return !OwnedItems.containsAny(ItemID.AVAS_ACCUMULATOR, ItemID.AVAS_ACCUMULATOR) && PaidQuest.ANIMAL_MAGNETISM.isFinished();
    }
