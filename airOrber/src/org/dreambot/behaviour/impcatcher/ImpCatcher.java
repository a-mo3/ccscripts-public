...
public class ImpCatcher extends Fractal {
    ...
    public ImpCatcher() {
        this.inventoryLoadout = new InventoryLoadout()
                .addItem(ItemID.RED_BEAD).setBuyPrice(ScriptSettings.getBeadBuyPrice())
                .addItem(ItemID.YELLOW_BEAD).setBuyPrice(ScriptSettings.getBeadBuyPrice())
                .addItem(ItemID.BLACK_BEAD).setBuyPrice(ScriptSettings.getBeadBuyPrice())
                .addItem(ItemID.WHITE_BEAD).setBuyPrice(ScriptSettings.getBeadBuyPrice())
                .setStrict(true)
        ;
    }
