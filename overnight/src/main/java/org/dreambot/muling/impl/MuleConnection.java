...
public class MuleConnection extends WebSocketClient {
    ...
    @SneakyThrows
    public MuleConnection(URI serverUri, boolean isMule) {
        super(serverUri);
        // todo set headers
    ...
    public void onMessage(String message) {
        ...
        Log.info("Message: " + jsonElement.getAsJsonObject());
        ...
        if (messageType == MessageType.MULE_REQUEST) {
            ...
            Log.info("Got & added a mule request.");
        }
    ...
    public void onClose(int code, String reason, boolean remote) {
        Log.info(String.format("MC closed: %d, %s", code, reason));
    }
    ...
    public void sendComplete() {
        if (muleResponse == null) {
            Log.info("couldnt complete request, response was null");
            return;
        }
