...
//                    return LoadoutExecutor.execEquipmentLoadout(this.equipmentLoadout);
                    Logger.info("Fractal equipment loadout " + new WithdrawLoadoutEvent(inventoryLoadout, equipmentLoadout).executed());
...
//                    return LoadoutExecutor.execInvLoadout(this.inventoryLoadout);
                    Logger.info("Fractal inventory loadout " + new WithdrawLoadoutEvent(inventoryLoadout, equipmentLoadout).executed());
                    return ReactionGenerator.getNormal();
                }
