...
public class SellAllEvent extends AbstractEvent {
    ...
    public int onLoop() {
        ...
        for (Integer id : items) {
            if (OwnedItems.containsUnworn(id) || OwnedItems.containsUnworn(new Item(id, 0).getNotedItemID())) {
                ...
                GrandExchange.sellItem(new Item(id, 0).getName(), Inventory.count(name),
                        (int) (LivePrices.get(id) * ScriptSettings.getSettingsData().discount));
